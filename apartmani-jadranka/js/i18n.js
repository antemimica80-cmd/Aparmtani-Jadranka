...
(function () {
  ...
  var DICT = {
    ...
    'stan.avail.book_airbnb': { hr: 'Rezerviraj preko Airbnb-a', en: 'Book via Airbnb' },
    'stan.avail.book_booking': { hr: 'Rezerviraj preko Booking.com-a', en: 'Book via Booking.com' },
