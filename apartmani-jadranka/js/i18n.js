...
(function () {
  ...
  var DICT = {
    ...
    'istok.sleeps': { hr: 'Do 6 gostiju · 2 spavaće sobe · 2 kupaonice', en: 'Sleeps up to 6 · 2 bedrooms · 2 bathrooms' },
    ...
    'istok.am_bathrooms': { hr: 'Dvije kupaonice', en: 'Two bathrooms' },
